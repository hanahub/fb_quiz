...
<div class="fb_wrap <?php echo $q_layout; ?>">
    ...
    <?php
        ...
        echo '<div class="fb_quiz_content">';
            echo '<div class="fb_quiz_left">';
                $i = 1;
                foreach ($questions as $q) {
                    if ($i == 1) $css = "fb_active";
                    else $css = "";
                    echo '<a href="javascript:void(0)" class="fb_quiz_nav ' . $css . '" question-no="' . $i . '">' . $i . '</a>';
                    $i ++;
                }
            echo '</div>';
            echo '<div class="fb_quiz_right">';
                $i = 1;
                foreach ($questions as $q) {
                    $choices = unserialize($q->choices);
                    echo '<div class="fb_row fb_question" id="fb_question' . $i . '">';
